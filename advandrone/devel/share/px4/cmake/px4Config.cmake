...
if("TRUE" STREQUAL "TRUE")
  set(px4_SOURCE_PREFIX /home/lybot/Desktop/advandrone/src/Firmware)
  set(px4_DEVEL_PREFIX /home/lybot/Desktop/advandrone/devel)
  set(px4_INSTALL_PREFIX "")
  set(px4_PREFIX ${px4_DEVEL_PREFIX})
else()
  set(px4_SOURCE_PREFIX "")
  set(px4_DEVEL_PREFIX "")
  set(px4_INSTALL_PREFIX /home/lybot/Desktop/advandrone/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'px4' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/lybot/Desktop/advandrone/src/Firmware/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/lybot/Desktop/advandrone/devel/lib;/home/lybot/Desktop/advandrone/devel/lib;/opt/ros/melodic/lib)
